...
class PracticePaperStudent extends StatefulWidget {
  @override
  _PracticePaperStudentState createState() => _PracticePaperStudentState();
}

class _PracticePaperStudentState extends State<PracticePaperStudent> {
